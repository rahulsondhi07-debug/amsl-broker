...
export const docUrl = (id, inline) => `${BASE}/documents/${id}/download${inline ? "?inline=1" : ""}`; // exported so components can build direct download links (e.g. bill files)
...
export const api = {
  ...
  permissionsEffective: (role, agentId, agencyId) =>
    request(`/permissions/effective`, { params: { role, agent_id: agentId, agency_id: agencyId } }),
  permissionEntities: (keys) => request(`/permissions/entities`, { params: keys ? { keys: keys.join(",") } : {} }),
  permissionEntitySet: (type, id, perm_key, allowed) =>
    request(`/permissions/entities/${type}/${id}`, { method: "PUT", body: { perm_key, allowed } }),
  permissionEntityGroup: (type, id, group, allowed) =>
    request(`/permissions/entities/${type}/${id}/group`, { method: "PUT", body: { group, allowed } }),
  ...
  groupQuotes: (params) => request(`/group-quotes`, { params }),
  groupQuote: (id) => request(`/group-quotes/${id}`),
  groupQuoteParse: (file_base64, filename, default_name) => request(`/group-quotes/parse`, { method: "POST", body: { file_base64, filename, default_name } }),
  groupQuoteCreate: (body) => request(`/group-quotes`, { method: "POST", body }),
  groupQuoteStatus: (id, status) => request(`/group-quotes/${id}/status`, { method: "PATCH", body: { status } }),
  groupQuoteCreateLeads: (id, body) => request(`/group-quotes/${id}/create-leads`, { method: "POST", body }),
  groupQuoteDelete: (id) => request(`/group-quotes/${id}`, { method: "DELETE" }),
  waterList: (params) => request(`/water-validation`, { params }),
  waterSummary: () => request(`/water-validation/summary`),
  waterGet: (id) => request(`/water-validation/${id}`),
  waterPreview: (body) => request(`/water-validation/preview`, { method: "POST", body }),
  waterCreate: (body) => request(`/water-validation`, { method: "POST", body }),
  waterUpdate: (id, body) => request(`/water-validation/${id}`, { method: "PUT", body }),
  waterStatus: (id, body) => request(`/water-validation/${id}/status`, { method: "PATCH", body }),
  waterDelete: (id) => request(`/water-validation/${id}`, { method: "DELETE" }),
  ...
  fvfDelete: (id) => request(`/fixed-vs-flex/${id}`, { method: "DELETE" }),
  fvfResult: (id) => request(`/fixed-vs-flex/${id}/result`),
  fvfSetRates: (id, lines) => request(`/fixed-vs-flex/${id}/lines`, { method: "PUT", body: { lines } }),
  fvfLineAdd: (id, body) => request(`/fixed-vs-flex/${id}/lines`, { method: "POST", body }),
  fvfLineDelete: (lineId) => request(`/fixed-vs-flex/lines/${lineId}`, { method: "DELETE" }),
  fvfGuidance: () => request(`/fixed-vs-flex/guidance/all`),
  flexBaskets: (params) => request(`/flex-basket/baskets`, { params }),
  flexBasketCreate: (body) => request(`/flex-basket/baskets`, { method: "POST", body }),
  flexBasketUpdate: (id, body) => request(`/flex-basket/baskets/${id}`, { method: "PUT", body }),
  flexBasketDelete: (id) => request(`/flex-basket/baskets/${id}`, { method: "DELETE" }),
  flexSnapshot: (id) => request(`/flex-basket/baskets/${id}/snapshot`),
  flexMembers: (id) => request(`/flex-basket/baskets/${id}/members`),
  flexMemberCreate: (id, body) => request(`/flex-basket/baskets/${id}/members`, { method: "POST", body }),
  flexMemberDelete: (id) => request(`/flex-basket/members/${id}`, { method: "DELETE" }),
  flexCurve: (id, params) => request(`/flex-basket/baskets/${id}/curve`, { params }),
  flexCurveSet: (id, body) => request(`/flex-basket/baskets/${id}/curve`, { method: "POST", body }),
  flexCurveImport: (id, rows) => request(`/flex-basket/baskets/${id}/curve/import`, { method: "POST", body: { rows } }),
  flexImportReport: (id, payload, report_date) => request(`/flex-basket/baskets/${id}/curve/import-report`, { method: "POST", body: { payload, report_date } }),
  flexRebuildSeasons: (id, utility) => request(`/flex-basket/baskets/${id}/curve/rebuild-seasons`, { method: "POST", body: { utility } }),
  flexTrades: (id) => request(`/flex-basket/baskets/${id}/trades`),
  flexTradesAdd: (id, trades, apply_to_curve = true) => request(`/flex-basket/baskets/${id}/trades`, { method: "POST", body: { trades, apply_to_curve } }),
  flexTradeDelete: (id) => request(`/flex-basket/trades/${id}`, { method: "DELETE" }),
  flexThresholds: (id) => request(`/flex-basket/baskets/${id}/thresholds`),
  flexThresholdSet: (id, body) => request(`/flex-basket/baskets/${id}/thresholds`, { method: "POST", body }),
  flexThresholdDelete: (id) => request(`/flex-basket/thresholds/${id}`, { method: "DELETE" }),
  flexHistoryRecord: (id, body) => request(`/flex-basket/baskets/${id}/history`, { method: "POST", body }),
  fvfRateCard: (id) => request(`/fixed-vs-flex/${id}/rate-card`),
  fvfRateCardSave: (id, card) => request(`/fixed-vs-flex/${id}/rate-card`, { method: "PUT", body: card }),
  fvfMonthly: (id) => request(`/fixed-vs-flex/${id}/monthly`),
  fvfMonthlySave: (id, rows) => request(`/fixed-vs-flex/${id}/monthly`, { method: "PUT", body: { rows } }),
  fvfDuplicate: (id, version_label) => request(`/fixed-vs-flex/${id}/duplicate`, { method: "POST", body: { version_label } }),
  fvfAddYear: (id, scenario) => request(`/fixed-vs-flex/${id}/years`, { method: "POST", body: { scenario } }),
  docTypes: () => request(`/documents/types`),
  docs: (params) => request(`/documents`, { params }),
  docGenerate: (body) => request(`/documents/generate`, { method: "POST", body }),
  docGeneratePack: (body) => request(`/documents/generate-pack`, { method: "POST", body }),
  docUpdate: (id, body) => request(`/documents/${id}`, { method: "PUT", body }),
  docDelete: (id) => request(`/documents/${id}`, { method: "DELETE" }),
  docSettings: () => request(`/documents/settings`),
  docSettingsSave: (body) => request(`/documents/settings`, { method: "PUT", body }),
  kbArticles: (params) => request(`/knowledge/articles`, { params }),
  kbArticleSave: (id, body) => (id ? request(`/knowledge/articles/${id}`, { method: "PUT", body }) : request(`/knowledge/articles`, { method: "POST", body })),
  kbArticleDelete: (id) => request(`/knowledge/articles/${id}`, { method: "DELETE" }),
  kbGlossary: (params) => request(`/knowledge/glossary`, { params }),
  kbGlossarySave: (id, body) => (id ? request(`/knowledge/glossary/${id}`, { method: "PUT", body }) : request(`/knowledge/glossary`, { method: "POST", body })),
  kbGlossaryDelete: (id) => request(`/knowledge/glossary/${id}`, { method: "DELETE" }),
  marketReports: (params) => request(`/knowledge/market-reports`, { params }),
  marketReport: (id) => request(`/knowledge/market-reports/${id}`),
  marketReportSave: (id, body) => (id ? request(`/knowledge/market-reports/${id}`, { method: "PUT", body }) : request(`/knowledge/market-reports`, { method: "POST", body })),
  marketReportRoll: (id) => request(`/knowledge/market-reports/${id}/roll-forward`, { method: "POST", body: {} }),
  marketReportDelete: (id) => request(`/knowledge/market-reports/${id}`, { method: "DELETE" }),
  hubs: () => request(`/knowledge/hubs`),
  hubCreate: (body) => request(`/knowledge/hubs`, { method: "POST", body }),
  hubUpdate: (id, body) => request(`/knowledge/hubs/${id}`, { method: "PUT", body }),
  hubDelete: (id) => request(`/knowledge/hubs/${id}`, { method: "DELETE" }),
  hubPublic: (token) => request(`/hub/${token}`),
  flexCurveDelete: (id) => request(`/flex-basket/curve/${id}`, { method: "DELETE" }),
  netSummary: () => request(`/network-charges/summary`),
  netDuos: (params) => request(`/network-charges/duos`, { params }),
  netDuosUpdate: (id, body) => request(`/network-charges/duos/${id}`, { method: "PUT", body }),
  netTnuos: () => request(`/network-charges/tnuos`),
  netTriads: (params) => request(`/network-charges/triads`, { params }),
  netTriadCreate: (body) => request(`/network-charges/triads`, { method: "POST", body }),
  netTriadUpdate: (id, body) => request(`/network-charges/triads/${id}`, { method: "PUT", body }),
  netTriadDelete: (id) => request(`/network-charges/triads/${id}`, { method: "DELETE" }),
  netDispatch: (params) => request(`/network-charges/dispatch`, { params }),
  netEstimate: (body) => request(`/network-charges/dispatch/estimate`, { method: "POST", body }),
  netDispatchCreate: (body) => request(`/network-charges/dispatch`, { method: "POST", body }),
  netDispatchUpdate: (id, body) => request(`/network-charges/dispatch/${id}`, { method: "PUT", body }),
  netDispatchDelete: (id) => request(`/network-charges/dispatch/${id}`, { method: "DELETE" }),
  carbonSummary: () => request(`/carbon/summary`),
  carbonFootprint: (businessId) => request(`/carbon/footprint`, { params: { business_id: businessId } }),
  carbonProjects: (params) => request(`/carbon/projects`, { params }),
  carbonProjectCreate: (body) => request(`/carbon/projects`, { method: "POST", body }),
  carbonProjectUpdate: (id, body) => request(`/carbon/projects/${id}`, { method: "PUT", body }),
  carbonProjectDelete: (id) => request(`/carbon/projects/${id}`, { method: "DELETE" }),
  carbonPools: (params) => request(`/carbon/pools`, { params }),
  carbonPoolCreate: (body) => request(`/carbon/pools`, { method: "POST", body }),
  carbonPoolUpdate: (id, body) => request(`/carbon/pools/${id}`, { method: "PUT", body }),
  carbonPoolDelete: (id) => request(`/carbon/pools/${id}`, { method: "DELETE" }),
  carbonAllocations: (params) => request(`/carbon/allocations`, { params }),
  carbonAllocationCreate: (body) => request(`/carbon/allocations`, { method: "POST", body }),
  carbonAllocationUpdate: (id, body) => request(`/carbon/allocations/${id}`, { method: "PUT", body }),
  carbonAllocationDelete: (id) => request(`/carbon/allocations/${id}`, { method: "DELETE" }),
  vppSummary: (params) => request(`/vpp/summary`, { params }),
  vppProgrammes: (params) => request(`/vpp/programmes`, { params }),
  vppProgrammeCreate: (body) => request(`/vpp/programmes`, { method: "POST", body }),
  vppProgrammeUpdate: (id, body) => request(`/vpp/programmes/${id}`, { method: "PUT", body }),
  vppProgrammeDelete: (id) => request(`/vpp/programmes/${id}`, { method: "DELETE" }),
  vppEligibleAssets: (params) => request(`/vpp/eligible-assets`, { params }),
  vppEnrolments: (params) => request(`/vpp/enrolments`, { params }),
  vppEnrolmentCreate: (body) => request(`/vpp/enrolments`, { method: "POST", body }),
  vppEnrolmentUpdate: (id, body) => request(`/vpp/enrolments/${id}`, { method: "PUT", body }),
  vppEnrolmentDelete: (id) => request(`/vpp/enrolments/${id}`, { method: "DELETE" }),
  vppEvents: (params) => request(`/vpp/events`, { params }),
  vppEventCreate: (body) => request(`/vpp/events`, { method: "POST", body }),
  vppEventDelete: (id) => request(`/vpp/events/${id}`, { method: "DELETE" }),
  vppParticipation: (params) => request(`/vpp/participation`, { params }),
  vppParticipationCreate: (body) => request(`/vpp/participation`, { method: "POST", body }),
  vppParticipationUpdate: (id, body) => request(`/vpp/participation/${id}`, { method: "PUT", body }),
  localAreas: () => request(`/local-energy/areas`),
  localStructures: () => request(`/local-energy/structures`),
