...
// Default multi-level split: Supplier -> Utility Live -> Master Broker -> Agent
const SPLIT = [{ level: "Utility Live", pct: 40 }, { level: "Master Broker", pct: 20 }, { level: "Agent", pct: 40 }];
