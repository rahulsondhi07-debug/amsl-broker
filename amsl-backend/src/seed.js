...
export function seed({ reset = false } = {}) {
  ...
  const agencyId = {};
  for (const n of ["Azentra Technologies", "linked", "Utility Live Portal"]) agencyId[n] = insAgency.run(n).lastInsertRowid;
  ...
  for (const a of [
    ...
    { name: "Admin Broker Portal", agency: "Utility Live Portal", email: "admin@brokerportal.com", role: "Admin", aircall: 1, pw: "admin123" },
  ...
  biz({ ref: "d8a9ec43", name: "test1", agency: "Utility Live Portal", agent: "Admin Broker Portal", stage: "LEAD", created: "2026-07-13", region: "West Midlands", meters: [{ u: "ELEC", s: "S", eac: 30000 }] });
  biz({ ref: "9d4127ac", name: "test1", agency: "Utility Live Portal", agent: "Admin Broker Portal", stage: "LEAD", created: "2026-07-13", region: "London", meters: [{ u: "GAS", s: "S", eac: 20000 }] });
  ...
  biz({ ref: "e8370d4e", name: "test1", contact: "Test Test", mobile: "+919638028505", agency: "Utility Live Portal", agent: "Admin Broker Portal", stage: "LEAD", created: "2026-05-29", region: "London", meters: [{ u: "ELEC", s: "S", eac: 25000 }, { u: "ELEC", s: "C", eac: 25000 }] });
  biz({ ref: "e8856009", name: "Pizza Hut", agency: "Utility Live Portal", agent: "Admin Broker Portal", stage: "LEAD", created: "2026-05-18", region: "London", meters: [{ u: "ELEC", s: "S", eac: 40000 }] });
  biz({ ref: "a1b2c3d4", name: "Pizza Hut", agency: "Utility Live Portal", agent: "Admin Broker Portal", stage: "LEAD", created: "2026-05-18", region: "London", meters: [{ u: "GAS", s: "S", eac: 40000 }] });
  ...
  biz({ ref: "c1000002", name: "Test Business", agency: "Utility Live Portal", agent: "Admin Broker Portal", stage: "CUSTOMER", created: "2026-06-11", region: "London", meters: [{ u: "ELEC", s: "S", eac: 30000 }] });
  biz({ ref: "c1000003", name: "test1", agency: "Utility Live Portal", agent: "Admin Broker Portal", stage: "CUSTOMER", created: "2026-05-29", region: "London", meters: [{ u: "ELEC", s: "S", eac: 30000 }] });
  biz({ ref: "c1000004", name: "joes", contact: "trert etery", email: "richrahulson@gmail.com", agency: "Utility Live Portal", agent: "Admin Broker Portal", stage: "CUSTOMER", created: "2026-05-18", region: "London" });
  ...
  for (const c of [
    { no: "CN-01", bn: "test1", sup: "Clear Buisness", agency: "Utility Live Portal", agent: "Admin Broker Portal", term: 12, meter: "1476876768653", cons: 30000, comm: 180.0, st: "Contract Sent to Client", created: "2026-05-20" },
    { no: "CN-02", bn: "test1", sup: "Clear Buisness", agency: "Utility Live Portal", agent: "Admin Broker Portal", term: 12, meter: "1476876768653", cons: 30000, comm: 180.0, st: "Contract Sent to Client", created: "2026-05-22" },
    { no: "CN-03", bn: "Ann Bird", sup: "Smartest Energy", agency: "Utility Live Portal", agent: "Admin Broker Portal", term: 12, meter: "1785245444454", cons: 35000, comm: 700.0, st: "Contract Sent to Client", created: "2026-06-02" },
